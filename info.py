...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/2de3c18c07ec3f9ce8c1f.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/Wdj.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2034654684').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002541109889').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001748572062'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002215662728'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002547841898'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001748572062'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002547841898')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001761418123')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001761418123')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002547841898').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002547841898').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'nsemperor@sbi')
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nehal969797:nehalsingh969797@cluster0.omrxu9o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://nehal969797:nehalsingh969797@cluster0.ect7puj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '7d706f6d7c95ff3fae2f2f40cff10abdc0e012e9')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/disneysworl_d')  # Tutorial video link for opening shortlink website
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Lordsakunaa')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/purplebotz')
OWNERID = int(os.environ.get('OWNERID', '2034654684'))  # Replace with the actual admin ID

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6951715555').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/disneysworl_d')  # Support group link (make sure bot is admin)
